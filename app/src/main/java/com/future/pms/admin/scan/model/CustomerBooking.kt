package com.future.pms.admin.scan.model
...
val dateOut: Long, @SerializedName("idBooking") val idBooking: String,
    ...
    @SerializedName("price") val price: Double, @SerializedName("totalPrice")
    val totalPrice: Double, @SerializedName("slotName") val slotName: String,
