...
class Content {
  ...
  @SerializedName("dateIn") val dateIn: Long? = null
  @SerializedName("dateOut") val dateOut: Long? = null
  @SerializedName("idBooking") val idBooking: String? = null
  @SerializedName("idParkingZone") val idParkingZone: String? = null
  @SerializedName("idSlot") val idSlot: String? = null
  @SerializedName("idUser") val idUser: String? = null
  @SerializedName("imageUrl") val imageUrl: String? = null
  @SerializedName("levelName") val levelName: Any? = null
  @SerializedName("parkingZoneName") val parkingZoneName: String? = null
